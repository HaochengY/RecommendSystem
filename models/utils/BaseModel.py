...
from models.utils.preprocess import DataRecorder


class BaseModel(nn.Module):
    def __init__(self, model_name, embedding_dim=4, num_epochs=5, learning_rate=0.01,
                 criterion_type="BCE", optimizer_type="SGD"):
        super(BaseModel, self).__init__()
        self.dataRecorder = DataRecorder(embedding_dim=embedding_dim)
