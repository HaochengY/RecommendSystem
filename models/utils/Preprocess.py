...
class DataRecorder:
    ...
    def create_dataset(self):
        if self.encoded_tensor.numel() == 0 or self.label_tensor.numel() == 0 or self.sponsor_id_tensor.numel() == 0:
            raise ValueError("create_dataset 的时候有空值")
        self.dataset = TensorDataset(self.encoded_tensor, self.label_tensor, self.sponsor_id_tensor)
